## apriltag (rolling) - 3.4.5-1

The packages in the `apriltag` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling apriltag` on `Fri, 29 Aug 2025 21:56:05 -0000`
...
## apriltag (jazzy) - 3.4.5-1

The packages in the `apriltag` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy apriltag` on `Fri, 29 Aug 2025 21:54:09 -0000`
...
## apriltag (humble) - 3.4.5-1

The packages in the `apriltag` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble apriltag` on `Fri, 29 Aug 2025 21:50:47 -0000`
...
## apriltag (rolling) - 3.4.4-1

The packages in the `apriltag` repository were released into the `rolling` distro by running `/usr/bin/bloom-release apriltag --rosdistro rolling` on `Sat, 26 Jul 2025 17:49:59 -0000`
...
## apriltag (jazzy) - 3.4.4-1

The packages in the `apriltag` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release apriltag --rosdistro jazzy` on `Sat, 26 Jul 2025 17:48:01 -0000`
